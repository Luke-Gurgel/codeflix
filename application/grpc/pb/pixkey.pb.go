...
type PixKeyCreationResult struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PixKeyCreationResult) Reset() {
	*x = PixKeyCreationResult{}
	if protoimpl.UnsafeEnabled {
...
func (x *PixKeyCreationResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PixKeyCreationResult) ProtoMessage() {}

func (x *PixKeyCreationResult) ProtoReflect() protoreflect.Message {
	mi := &file_pixkey_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PixKeyCreationResult.ProtoReflect.Descriptor instead.
func (*PixKeyCreationResult) Descriptor() ([]byte, []int) {
	return file_pixkey_proto_rawDescGZIP(), []int{4}
}

func (x *PixKeyCreationResult) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *PixKeyCreationResult) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *PixKeyCreationResult) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
var file_pixkey_proto_rawDesc = []byte{
	...
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x4c, 0x75, 0x6b, 0x65, 0x47,
	0x75, 0x72, 0x67, 0x65, 0x6c, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x66, 0x6c, 0x69, 0x78, 0x22, 0x58,
	...
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x44, 0x22, 0x2e, 0x0a, 0x06, 0x50, 0x69, 0x78, 0x4b,
	...
	0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x4c, 0x75, 0x6b, 0x65,
	0x47, 0x75, 0x72, 0x67, 0x65, 0x6c, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x66, 0x6c, 0x69, 0x78, 0x2e,
	...
	0x0a, 0x14, 0x50, 0x69, 0x78, 0x4b, 0x65, 0x79, 0x43, 0x72, 0x65, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
...
var file_pixkey_proto_goTypes = []interface{}{
	(*PixKeyRegistration)(nil),   // 0: github.com.LukeGurgel.codeflix.PixKeyRegistration
	(*PixKey)(nil),               // 1: github.com.LukeGurgel.codeflix.PixKey
	(*Account)(nil),              // 2: github.com.LukeGurgel.codeflix.Account
	(*PixKeyInfo)(nil),           // 3: github.com.LukeGurgel.codeflix.PixKeyInfo
	(*PixKeyCreationResult)(nil), // 4: github.com.LukeGurgel.codeflix.PixKeyCreationResult
}
var file_pixkey_proto_depIdxs = []int32{
	2, // 0: github.com.LukeGurgel.codeflix.PixKeyInfo.account:type_name -> github.com.LukeGurgel.codeflix.Account
	0, // 1: github.com.LukeGurgel.codeflix.PixService.RegisterPixKey:input_type -> github.com.LukeGurgel.codeflix.PixKeyRegistration
	1, // 2: github.com.LukeGurgel.codeflix.PixService.Find:input_type -> github.com.LukeGurgel.codeflix.PixKey
	4, // 3: github.com.LukeGurgel.codeflix.PixService.RegisterPixKey:output_type -> github.com.LukeGurgel.codeflix.PixKeyCreationResult
	3, // 4: github.com.LukeGurgel.codeflix.PixService.Find:output_type -> github.com.LukeGurgel.codeflix.PixKeyInfo
...
func file_pixkey_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pixkey_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PixKeyCreationResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
